...
- 对外 bot 命令面只保留：`/list`、`/projects`、`/project_add <name> <abs-path>`、`/project_remove <name>`、`/open <project> [thread-id]`、`/close`、`/kill`、`/clear`、`/status`、`/model [model]`、`/reasoning [effort]`、`/plan_mode [default|plan]`。
